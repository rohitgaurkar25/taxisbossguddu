...
const CACHE_NAME = 'taxisbossguddu.godaddysites.com-1612334849111';
const SW_SUPPORTED_PROTOCOL_REGEX = /http(s?):/;
const pageUrls = JSON.parse('["/","/markup/ad","/markup/paywall"]');
const staticAssets = JSON.parse('["https://img1.wsimg.com/poly/v2/polyfill.min.js?unknown=polyfill&flags=gated&features=default%2Cfetch%2CArray.prototype.%40%40iterator%2CArray.prototype.find%2CArray.prototype.findIndex%2CFunction.name%2CNumber.isFinite%2CPromise%2CString.prototype.repeat%2CMath.sign%2CMath.trunc%2CArray.prototype.includes%2CObject.entries%2CObject.values%2CObject.is%2CIntersectionObserver%2CIntl.~locale.en-IN","//img1.wsimg.com/blobby/go/60428ed0-a146-4c5e-9e9d-93f5a1640309/gpub/90c3e2584f677cb8/script.js","//img1.wsimg.com/ceph-p3-01/website-builder-data-prod/static/widgets/UX.4.3.0.js","//fonts.googleapis.com/css?family=Karla:400,700&display=swap","//fonts.googleapis.com/css?family=Old+Standard+TT:400,400i,700,700i&display=swap"]');
const networkOnlyUrls = JSON.parse('["https://api.ola.godaddy.com","https://60428ed0-a146-4c5e-9e9d-93f5a1640309.onlinestore.godaddy.com","https://img.secureserver.net/t/1/tl/event","https://img.test-secureserver.net/t/1/tl/event","https://www.google-analytics.com/collect","https://calendar.apps.dev-secureserver.net","https://calendar.apps.test-secureserver.net","https://calendar.apps.secureserver.net"]');
const networkOnlyUrlsRegex = JSON.parse('["taxisbossguddu.godaddysites.com/m/api/.*","taxisbossguddu.godaddysites.com(?:/.*)?/ola/services/.*","taxisbossguddu.godaddysites.com/ola/meetings/.*","securepay.godaddy.com/api/apps/ola/accounts/.*"]').map(regexString => new RegExp(regexString));
const networkThenCacheUrls = JSON.parse('["https://blog.apps.secureserver.net/v1/website/60428ed0-a146-4c5e-9e9d-93f5a1640309/feed/post/","https://blog.apps.secureserver.net/v1/website/60428ed0-a146-4c5e-9e9d-93f5a1640309/feed"]');
const networkThenCacheUrlsRegex = JSON.parse('["taxisbossguddu.godaddysites.com(?:/.*)?/f/.*"]').map(regexString => new RegExp(regexString));
